						...
						<TR>
							...
							<TD>
								<form id="condition" name="condition" method="post"
									action="${pageContext.request.contextPath}/people/login.do">
									<TABLE cellSpacing=0 cellPadding=2 border=0>
										<TBODY>
											<TR>
												<TD style="HEIGHT: 28px" width=80>账号：</TD>
												<TD style="HEIGHT: 28px" width=150><INPUT id=peopleName
													style="WIDTH: 130px" name="peopleName"
													value="${people.peopleName}"></TD>
											</TR>
											<TR>
												<TD style="HEIGHT: 28px">密码：</TD>
												<TD style="HEIGHT: 28px"><INPUT id=passWord
													style="WIDTH: 130px" type=password name="passWord"
													value="${people.passWord}"></TD>
											</TR>
											<TR>
